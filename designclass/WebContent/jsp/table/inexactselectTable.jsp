...
<%
	...
	String inexactStr = session.getAttribute("inexactStr").toString();
...
<div style="margin:0 auto;text-align:center;">
	...
	<div style="margin:0 auto">
		<tr>
				...
				<td>总页数:<%=totalPage %></td>
				&nbsp;
				<td><a href="/designclass/serial/inexactFindSeriInfos.do?currentPage=<%=currentPage+1 %>&inexactStr=<%=inexactStr %>" style="color:blue">下一页--></a></td>
		</tr>
	</div>	
</div>	
</body>
